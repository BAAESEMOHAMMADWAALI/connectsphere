...
connectsphere is a Spring Boot microservices backend scaffold for an Instagram-style social platform. This baseline sets up the service boundaries, build system, infrastructure definitions, and starter APIs so implementation can continue service-by-service without reworking the repo layout.
